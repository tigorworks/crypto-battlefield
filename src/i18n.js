...
import { renderRecord } from './ui/killfeed.js';
      ...
      export const I18N = {
        en: {
          ...
          keysLine3: '<b>tap soldier</b> follow · <b>tap ground</b> release',
          ...
          whaleTag: 'WHALE', liqTag: 'LIQUIDATED',
          liqLongs: 'LONGS', liqShorts: 'SHORTS',
          liqEventLongs: 'Longs wiped out', liqEventShorts: 'Shorts wiped out',
        ...
        id: {
          ...
          keysLine3: '<b>ketuk prajurit</b> ikuti · <b>ketuk tanah</b> lepas',
          ...
          liqLongs: 'LONG', liqShorts: 'SHORT',
          liqEventLongs: 'Long tersapu habis', liqEventShorts: 'Short tersapu habis',
